...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.ProjectId).HasName("PK__Research__761ABED0BE672CCE");
        ...
        {
            entity.HasKey(e => e.ResearcherId).HasName("PK__Research__7CC06F0557A79F54");

            entity.ToTable("Researcher");

            entity.HasIndex(e => e.Email, "UQ__Research__A9D1053446ED2D39").IsUnique();
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__UserAcco__1788CCAC5E42F39C");

            entity.ToTable("UserAccount");

            entity.HasIndex(e => e.Email, "UQ__UserAcco__A9D10534B931A750").IsUnique();
