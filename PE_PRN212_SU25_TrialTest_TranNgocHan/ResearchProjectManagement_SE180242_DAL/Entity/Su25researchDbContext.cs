...
namespace ResearchProjectManagement_SE180242_DAL;
...
public partial class Su25researchDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.ProjectId).HasName("PK__Research__761ABED066F8A29E");
        ...
        {
            entity.HasKey(e => e.ResearcherId).HasName("PK__Research__7CC06F05B197BD51");

            entity.ToTable("Researcher");

            entity.HasIndex(e => e.Email, "UQ__Research__A9D10534B19A48B9").IsUnique();
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__UserAcco__1788CCAC7CF6F36C");

            entity.ToTable("UserAccount");

            entity.HasIndex(e => e.Email, "UQ__UserAcco__A9D10534653F972E").IsUnique();
